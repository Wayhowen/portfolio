...
export const schoolProjects: Project[] = [
  { projectName: "Time Reversal", projectDescription: "Test description 3", ref: true },
...
export const workProjects: Project[] = [
  { projectName: "Content Moderation Platform", projectDescription: "Test description 1", ref: true },
...
export const ownProjects: Project[] = [
  { projectName: "margin-bot", projectDescription: "Test description 1", ref: true },
